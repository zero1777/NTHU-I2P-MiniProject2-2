...
void SettingScene::Initialize() {
    ...
    // Back button
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW * 3 / 2 - 100, halfH * 2 - 50 - 150, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingScene::PlayOnClick, this, 0));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW * 3 / 2 + 100, halfH * 2 - 150, 0, 0, 0, 255, 0.5, 0.5));
